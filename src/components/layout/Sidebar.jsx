    ...
    <>
      ...
      <div>
        <div className="h-16 px-4 flex items-center justify-between border-b border-slate-100/80 dark:border-slate-800">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-700 via-blue-600 to-sky-400 flex items-center justify-center text-white shadow-md shadow-blue-500/20 shrink-0">
            ...
            {!collapsed && (
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-semibold tracking-widest text-blue-600 uppercase mt-0.5">
                  INFOTECH
                </span>
              </div>
            )}
