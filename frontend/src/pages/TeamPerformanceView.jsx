    ...
    <div className="space-y-4 sm:space-y-6 pb-20 lg:pb-12 text-slate-800 dark:text-slate-100">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4">
        ...
        <div className="card-base p-3 sm:p-4 rounded-md border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm flex flex-col justify-between">
          <div className="w-8 h-8 rounded-md bg-blue-500/10 text-blue-600 flex items-center justify-center shrink-0 mb-1">
        ...
        <div className="card-base p-3 sm:p-4 rounded-md border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm flex flex-col justify-between">
          <div className="w-8 h-8 rounded-md bg-emerald-500/10 text-emerald-600 flex items-center justify-center shrink-0 mb-1">
        ...
        <div className="card-base p-3 sm:p-4 rounded-md border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm flex flex-col justify-between">
          <div className="w-8 h-8 rounded-md bg-amber-500/10 text-amber-500 flex items-center justify-center shrink-0 mb-1">
        ...
        <div className="card-base p-3 sm:p-4 rounded-md border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm flex flex-col justify-between">
          <div className="w-8 h-8 rounded-md bg-purple-500/10 text-purple-600 flex items-center justify-center shrink-0 mb-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-4 space-y-4">
          {/* Top Performers Card */}
          <div className="card-base p-4 rounded-md border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm space-y-2.5">
            ...
            <div className="space-y-2 text-xs font-extrabold">
              {topPerformers.map((tp, idx) => (
                <div key={tp.name} className="flex justify-between items-center p-2 rounded-md bg-slate-50 dark:bg-slate-800/60">
          ...
          <div className="card-base p-4 rounded-md border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm space-y-2.5">
            ...
            <div className="space-y-2 text-xs font-extrabold">
              {needsImprovement.map((ni) => (
                <div key={ni.name} className="flex justify-between items-center p-2 rounded-md bg-slate-50 dark:bg-slate-800/60">
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 animate-in fade-in">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md-3xl shadow-2xl w-full max-w-lg p-6 space-y-5">
            ...
            <div className="grid grid-cols-4 gap-2 text-center">
              <div className="p-2.5 rounded-md bg-blue-50 dark:bg-blue-950/50 border border-blue-100 dark:border-blue-900">
              ...
              <div className="p-2.5 rounded-md bg-amber-50 dark:bg-amber-950/50 border border-amber-100 dark:border-amber-900">
              ...
              <div className="p-2.5 rounded-md bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-100 dark:border-emerald-900">
              ...
              <div className="p-2.5 rounded-md bg-purple-50 dark:bg-purple-950/50 border border-purple-100 dark:border-purple-900">
            ...
            <div className="pt-2 flex justify-end">
              <button
                onClick={() => setSelectedEmployeeForReport(null)}
                className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs rounded-md shadow-md cursor-pointer"
              >
                Close Report
              </button>
            </div>
